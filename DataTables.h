...
private:
	 ...
	 */
	BUFFER_1(uint64, rank_adjacent, 64);

	/**
	 * Bitboard representing the rank that a given square lies on:
	 */
	BUFFER_1(uint64, ranks64, 64);
